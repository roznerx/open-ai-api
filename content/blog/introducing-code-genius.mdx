...
- **Start creating an app from scrach**: <p>You decribe in simple words what you would like to create and Code Genius will help you organize the project.</p>
- **Creating unit test code**: <p>Testing code is important but sometimes we don't have the time to do it.</p>
  Code Genius can generate unit tests from existing code in seconds. Additionally you have the avility to choose your prefered testing libraries and frameworks.
- **Creating documentation**: <p>You just need to copy/paste your esisting code, Code Genius will analyse and generate detail docs for you.</p>
...
The Code Genius Chat interface is intuitive and accepts any type of queries, from SQL queries to AWS, or maybe you would like to know how to fetch data in a React App.
We got you cover.

In the following example we could see how the user interacts with Code Genius and ask the following:
...
Don't wait more to unlock the posibillities Code Genius offers to you. Go ahead and give it a try.
[Sign In](/?action=signUp)
