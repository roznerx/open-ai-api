...
summary: The only secret to be a genius is to have questions and look for the answers.
...
Since the launch of [Chat GPT](https://chat.openai.com/), on December 2022, we noticed an interesting pattern – _more and more developers were relaying on AI to help themself with daily tasks_.
