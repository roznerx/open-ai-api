...
export default function BlogLayoutHero() {
  ...
  return (
    <MaxWidthWrapper className="h-52 bg-gradient-to-r from-mint to-blue pb-20 sm:h-52">
      <div className="mt-12 flex flex-col justify-center">
        <div className="flex items-center justify-center">
          <h2 className="mt-7 font-sans text-3xl font-semibold text-white sm:text-4xl">
