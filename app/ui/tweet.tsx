...
export default function Tweet({
  ...
  const TweetBody = (
    ...
    >
      ...
      <div className="text-sm flex justify-center space-x-8 text-gray-500">
        <a
        ...
        <a
          className="hover:text-blue-600 group flex items-center space-x-3"
          href={reply_url}
          target="_blank"
          rel="noreferrer"
        >
          <Message className="group-hover:fill-blue-600 h-4 w-4" />
