...
export default function Feature() {
  return (
    <>
      <section>
        <h1 className="block text-center text-5xl font-bold text-gray-700 dark:text-white">
      ...
      <section className="mt-20">
        <h1 className="mx-auto block max-w-md text-center text-5xl font-bold text-gray-700 dark:text-white">
