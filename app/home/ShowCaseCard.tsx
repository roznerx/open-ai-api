...
export default function ShowCaseCard({
  ...
  return (
    <div className="group relative my-14 sm:my-20">
      ...
      <div className="font-inter relative mx-auto flex h-auto w-[90%] cursor-pointer items-center rounded-3xl bg-purple-700 p-6 text-center shadow-xl outline-none focus-visible:ring-2 sm:min-h-[404px] sm:w-[80%] md:h-[5.625rem]">
