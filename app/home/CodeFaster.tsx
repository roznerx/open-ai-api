  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mt-4 w-full max-w-sm text-center text-3xl font-semibold leading-tight text-white sm:max-w-xs">
          {translations.cloud}
        </p>
      </div>
      ...
      >
        ...
        <p className="mx-auto mt-4 w-full max-w-sm text-center text-3xl font-semibold leading-tight text-white sm:max-w-xs">
          {translations.layers}
        </p>
      </div>
    </div>
