  ...
  return (
    <>
      {generatedResponse.length === 0 && (
        <div className="absolute top-16 z-30 w-full bg-transparent sm:top-24">
          <h2 className="mx-auto flex w-full items-start justify-center text-3xl text-gray-200 sm:text-4xl">
